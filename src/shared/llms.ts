...
export function buildLlmsFullTxt(): string {
  return [
    ...
    "- Batch endpoint: https://concierge.tickadoo.com/api/schema/batch/west-end",
    "- Single product: https://concierge.tickadoo.com/api/schema/{slug}",
    "",
    "## AI Agent Discovery",
    "- For AI developer page: https://concierge.tickadoo.com/for-ai",
    "- Agent registry: https://concierge.tickadoo.com/.well-known/agent.json",
    ...
    "  GET https://concierge.tickadoo.com/api/accessibility/{venue-slug}",
    "  GET https://concierge.tickadoo.com/api/accessibility/city/London",
