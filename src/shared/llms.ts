...
const TOOL_DOCS: ToolDoc[] = [
  {
    ...
    inputs: [
      ...
      "setting (optional): Indoor, Outdoor, or Mixed. Indoor includes Mixed. Use for rainy day or outdoor queries",
      "wheelchair_accessible (optional): boolean true/false. Filter for wheelchair-accessible experiences",
      "physical_level (optional): Easy, Moderate, or Demanding. Filter by physical difficulty",
      "min_duration (optional): minimum duration in minutes (e.g. 60 for at least 1 hour)",
