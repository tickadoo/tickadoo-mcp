...
export function buildLlmsFullTxt(): string {
  return [
    ...
    "",
    "### Tags (per product)",
    "Musical, WestEnd, WalkingTour, FoodTour, Museum, Outdoor, HiddenGem, MustSee, Evening, Morning, Seasonal, Bestseller",
    "",
    ...
    "",
    "## Capabilities",
    "- Live experience discovery across 680+ cities worldwide with 13,000+ enriched products",
